...
public class AddressBook {
	...
	public static void deleteContact() {
		...
		for (int i = 0; i < contactArrayList.size(); i++) {
			if (contactArrayList.get(i).getFirstName().equals(firstName)
					&& contactArrayList.get(i).getLastName().equals(lastName)) {
	...
	private static void printContact(String firstName, String lastName, String address, String city, String state,
			String email, int zipCode, long mobileNumber) {
